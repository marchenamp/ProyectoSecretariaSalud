        ...
        <div class="body-styles">
            <div class="tabla-container">
                <table>
                    ...
                    <tbody>
                        <%= ca.obtenerTablaArchivos(Integer.parseInt(idExpediente))%>
                    </tbody>
                </table>
            </div>    
            ...
            <div class="botones">
                ...
                <form id="form-ver-archivos" action="agregarArchivo.jsp" method="post">
                    <input type="hidden" name="idExpediente" value="<% out.println(idExpediente);%>">
                    <button type="button" style="background-color: #aeaeae; color: black; width: 200px;" id="regresar-btn" onclick="document.getElementById('form-ver-archivos').submit();">Agregar</button>
                </form>
            </div>
        </div>
